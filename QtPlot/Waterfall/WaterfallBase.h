...
class QTPLOT_EXPORT WaterfallBase : public QtPlot
{
	Q_OBJECT

public:
	explicit WaterfallBase(QWidget* parent);
	~WaterfallBase() override;
	...
	virtual void setInterval(int minval, int maxval) const;
...
protected:
	...
	WaterfallContent* content = nullptr;
