...
/* including file 'src/_layer.h', size 6885                                   */
/* commit ce344b3f96a62e5f652585e55f1ae7c7883cd45b 2018-06-25 01:03:39 +0200 */
...
public:
  ...
  /*!
    Defines the different rendering modes of a _layer. Depending on the mode, certain layers can be
...
public:
  /*!
    Defines how a _layer should be inserted relative to an other _layer.

    \see addLayer, moveLayer
  */
  enum LayerInsertMode { limBelow  ///< Layer is inserted below other _layer
                         ,limAbove ///< Layer is inserted above other _layer
                       };
...
/*! \class QCPAbstractPlottable1D
  ...
  again, to provide a more accurate hit setOffset based on their specific data visualization geometry.
*/
...
/*!
  ...
  accurate hit setOffset based on the true data visualization geometry.
